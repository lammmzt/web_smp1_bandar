            ...
            <form action="<?= base_url('Ekskul/simpan'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="text" name="deskripsi_ekskul" id="deskripsi_ekskul" class="form-control" required
                            placeholder="Masukkan deskripsi statff">
                    </div>
                    <div class="form-group mt-2">
