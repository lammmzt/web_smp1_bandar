        ...
        <div class="container">
            <div class="row d-flex justify-content-center text-center">
                <div class="col-lg-8">
                    ...
                    <p class="mb-0">
                        Daftar Fasilitas dari <?= $data_sekolah['nama_sekolah']; ?>.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="container">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-4 data-item" data-aos="fade-up" data-aos-delay="200">
                            <div class="card">
                                <a href="<?= base_url('Assets/img/fasilitas/' . $fasilitas['foto_fasilitas']); ?>"
                                    target="_blank" data-fancybox="gallery"
                                    data-caption="<?= $fasilitas['nama_fasilitas']; ?>">
                        ...
                        ?>
                        <div class="col-12">
                            <p class="text-center">Tidak ada fasilitas yang ditemukan.</p>
                        </div>
                        <?php 
                            endif;
                        ?>
