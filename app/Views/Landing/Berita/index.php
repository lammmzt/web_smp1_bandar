            ...
            <section id="blog-posts" class="blog-posts section">
                ...
                <div class="container">
                    ...
                    <div class="row gy-4">
                        ...
                        ?>
                        <div class="col-12 data-item" data-judul="<?= $berita['judul_pengumuman']; ?>"
                            data-tag="<?= $berita['tag_pengumuman']; ?>">
                            <article>
                                ...
                                <div class="post-img">
                                    ...
                                    <?php
                                        if ($berita['type_media'] == '0') {
                                            ...
                                            echo '<iframe width="100%" height="300" src="' . $berita['nama_media'] . '" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                                        }
                                    ?>
                                </div>
                                ...
                                <div class="meta-top">
                                    <ul>
                                        ...
                                        <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a
                                                href="#"><time
                                                    datetime="<?= $berita['created_at']; ?>"><?= date('d M Y', strtotime($berita['created_at'])); ?></time></a>
                                        <li class="d-flex align-items-center"><i class="bi bi-eye"></i> <a
                                                href="#"><?= $berita['views_pengumuman']; ?> Views</a></li>
                                    </ul>
                                </div>

                                <div class="content">
                                    <p>
                                        <?= substr($berita['deskripsi_pengumuman'], 0, 300); ?>...
                                    </p>
