        ...
        <div class="container">
            <div class="row d-flex justify-content-center text-center">
                <div class="col-lg-8">
                    ...
                    <p class="mb-0">
                        Detail pengumuman <?= $detail_pengumuman['judul_pengumuman']; ?> yang diposting pada
                        <?= date('d M Y', strtotime($detail_pengumuman['created_at'])); ?> oleh
                        <?= $detail_pengumuman['nama_user']; ?>.
                        <br>
                    </p>
                </div>
            </div>
    ...
    <nav class="breadcrumbs">
        <div class="container">
            <ol>
                ...
                <li><a href="<?= base_url('Pengumumans'); ?>" class="text-decoration-none text-dark">Pengumuman</a></li>
            ...
            <section id="blog-details" class="blog-details section">
                <div class="container">
                    ...
                    <article class="article">
                        ...
                        <div class="post-img">
                            <?php
                                if ($detail_pengumuman['type_media'] == '0') {
                                    echo '<img src="' . base_url('Assets/img/pengumuman/' . $detail_pengumuman['nama_media']) . '" class="img-fluid" alt="">';
                                } else {
                                    echo '<iframe width="100%" height="300" src="' . $detail_pengumuman['nama_media'] . '" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                                }
                            ?>
                        </div>
                        ...
                        <div class="meta-top">
                            <ul>
                                <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a
                                        href="#"><?= $detail_pengumuman['nama_user']; ?></a></li>
                                <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="#"><time
                                            datetime="<?= $detail_pengumuman['created_at']; ?>"><?= date('d M Y', strtotime($detail_pengumuman['created_at'])); ?></time></a>
                                <li class="d-flex align-items-center"><i class="bi bi-eye"></i> <a
                                        href="#"><?= $detail_pengumuman['views_pengumuman']; ?> Views</a></li>
                            </ul>
                        </div><!-- End meta top -->

                        <div class="content">
                            <?= $detail_pengumuman['deskripsi_pengumuman']; ?>
